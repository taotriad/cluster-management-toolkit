...
#### Open file viewer
  ...
  _ansible_, _bash_, _caddyfile_, _cel_, _crt_, _css_, _docker_,
  _dmesg_, _diff_|_patch_, _go_, _html_, _ini_, _javascript_|_js_,
  _json_, _markdown_|_md_, _ndjson_, _powershell_|_ps1_,
  _promql_, _python_|_py_, _rego_, _shell_|_sh_, _svg_,
  _toml_, _xhtml_, _xml_, _yaml_
