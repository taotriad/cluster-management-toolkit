...
be good to consult the [project roadmap](roadmap/Project_roadmap.md#project-roadmap).
...
* [ ] Go to GitHub and and do the following:
  * [ ] Choose "Releases" on the right side of the screen.
  * [ ] Choose "Draft a new release" at the top right of the screen.
  * [ ] Pick the tag you just created and pushed in the steps above.
  * [ ] Insert the parts of CHANGELOG related to this release.
  * [ ] Press "Save draft".
  * [ ] Go back to releases by pressing "<- Releases" at the top left of the screen.
  * [ ] Download any assets generated by GitHub (typically `.tar.gz` and `.zip`).
  * [ ] Sign the assets using `gpg --armor --detach-sign <asset>`.
  * [ ] Go back to your draft and attach the signatures (`<asset>.asc`)
        using "Attach binaries [...]"
  * [ ] Ensure that "Set as the latest release" is checked.
  * [ ] Press "Publish release".
* Congratulations! You've created a new release!
