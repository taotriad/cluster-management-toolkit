...
def main() -> None:
    ...
    for filepath in template_entry.iterdir():
        ...
        if dest_filename.endswith(".yaml") and rendered.startswith("---\n"):
            template_blurb: str = \
                "---\n" \
                "# WARNING: Do NOT edit this file directly; it is generated from the template\n" \
                f"# {filepath}\n" \
                "# edit that file instead.\n" \
                "#\n"
            rendered = template_blurb + rendered[len("---\n"):]
