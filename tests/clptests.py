...
from clustermanagementtoolkit import commandparser
...
def test_parse_commandline(verbose: bool = False) -> tuple[str, bool]:
    ...
    if result:
        ...
        #  expected_result, theme, expected_exception, expected_exception_msg)
        testdata: tuple = (
                ...
                ["clptests", "help"],
                {
                    "__global_options": {
                        ...
                        "options": {
                            "--read-only": {
                                "description":
                                    [ANSIThemeStr("disable all commands that modify state",
                                                  "description")],
                                "extended_description": [
            ...
            # No args; options; no command; default
            (
                "clptests",
                "v42",
                "tests for commandparser.py",
            ...
            # option requires arg; not getting any
            (
                "clptests",
                "v42",
                "tests for commandparser.py",
                "various people",
                ["clptests", "hello", "--takes-an-integer"],
                {
                    "Hello World": {
                        "command": ["hello"],
                        "description": [
            ...
            (
                ...
                (
                    test_callback,
                    [("--no-args", ""), ("--takes-an-integer", 4), ("__commandname", "hello")],
                    ["foo"],
                ),
                None,
                None,
            ...
            # Too many args, 0 expected
            (
                "clptests",
                "v42",
                "tests for commandparser.py",
                "various people",
                ["clptests", "hello", "foo", "bar"],
                {
                    "Hello World": {
                        "command": ["hello"],
                        "description": [
            ...
            # Too few args, 1 required, one optional
            (
                "clptests",
                "v42",
                "tests for commandparser.py",
                        ...
                        "optional_args": [
                            {
                                "name": "optional_arg",
                                "string": [
                                    ANSIThemeStr("optional arg", "argument")
                                ],
                                "validation": {
                                    "validator": "int",
                                },
            ...
            # Too many args, 1 required, 1 optional
            (
                "clptests",
                "v42",
                "tests for commandparser.py",
                "various people",
                ["clptests", "hello3", "foo", "bar", "baz"],
                {
                    "Hello World": {
                        "command": ["hello3"],
                        "description": [
            ...
            (
                ...
                ["clptests", "help"],
                {
                    "Hello World": {
                        ...
                        "description": [
                            ANSIThemeStr("Update the package cache and show software versions"
                                         "very, very, very, very long line", "description")],
                        "extended_description": [
                            [ANSIThemeStr("Note", "note"),
                             ANSIThemeStr(": some of the listed software may not be",
                                          "description")],
            ...
            (
                ...
                ["clptests", "help", "--format", "markdown"],
                {
                    "Hello World": {
                        "command": ["hello"],
                        "description": [
                            ANSIThemeStr("Bla bla bla",
                                         "description"),
                            ANSIThemeStr("", "version"),
                            ANSIThemeStr("v1.2.3",
                                         "version")],
                        "extended_description": [
                            [ANSIThemeStr("Note", "note"),
                             ANSIThemeStr(": this is ",
                                          "description"),
                             ANSIThemeStr("not", "emphasis"),
                             ANSIThemeStr(" version ", "description"),
                             ANSIThemeStr("", "emphasis"),
                             ANSIThemeStr("v1.2.3", "emphasis")],
                            [ANSIThemeStr("be relevant to the configuration in use",
                                          "description")],
                        ],
                        "required_args": [
                            {
            ...
            (
                ...
                "tests for commandparser.py",
                "various people",
                ["clptests", "hello", "foo", "--happiness"],
                {
                    "Hello World": {
                        "command": ["hello"],
                        "description": [
                            ANSIThemeStr("Salutations to the world", "description")],
                        "options": {
                            "--happiness": {
                                "description": [
                                    ANSIThemeStr("Be happier", "description")],
        ...
        for programname, programversion, programdescription, programauthors, \
                argv, commandline, default_command, \
                expected_result, theme, expected_exception, expected_exception_msg in testdata:
            try:
    ...
    if result:
        ...
        testdata: tuple = (
            ...
            (
                ...
                "hello",
                ("hello", test_callback, "Hello World", [], []),
                None,
            ),
