            ...
            (
                ...
                [[ThemeStr('age', ThemeAttr('types', 'key'), False),
                 ...
                 [ThemeStr('list', ThemeAttr('types', 'key'), False),
                  ThemeRef('separators', 'id_prefix', False),
                  ThemeStr('1', ThemeAttr('types', 'field'), False),
                  ThemeRef('separators', 'list', False),
                  ThemeStr('2', ThemeAttr('types', 'field'), False),
                  ThemeRef('separators', 'list', False),
                  ThemeStr('3', ThemeAttr('types', 'field'), False),
                  ThemeStr('', ThemeAttr('types', 'generic'), False)],
...
def test_format_caddyfile(verbose: bool = False) -> tuple[str, bool]:
    ...
    if result:
        try:
            from pygments.lexers.configs import CaddyfileLexer  # noqa: F401,E501 type: ignore[attr-defined]
